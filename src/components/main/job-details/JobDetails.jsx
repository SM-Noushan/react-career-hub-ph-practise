...
const JobDetails = () => {
    ...
    return (
        <>
            ...
            <div className="max-w-[425px] md:container xl:max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-6 my-24 px-4">
                <div className="md:col-span-3 lg:col-span-4 font-extrabold text-justify space-y-4">
                ...
                <div className="md:col-span-3 lg:col-span-2">
                    <div className="rounded-xl bg-[linear-gradient(90deg,rgba(126,144,254,0.10)0%,rgba(152,115,255,0.10)100%)] p-8 xl:text-xl">
                    ...
                    <button onClick={handleApplyJob} className="btn bg-gradient-to-r from-grad-01 to-grad-02 text-white text-xl font-extrabold mt-6 w-full"> Apply Now</button>
                </div>
            </div>
        </>
    );
